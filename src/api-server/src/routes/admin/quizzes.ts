...
router.post("/quizzes", logAdminActivity("create_quiz", "quiz"), async (req, res) => {
  try {
...
router.patch("/quizzes/:id", logAdminActivity("update_quiz", "quiz"), async (req, res) => {
  try {
    const id = parseInt(req.params.id);
...
router.delete("/quizzes/:id", logAdminActivity("delete_quiz", "quiz"), async (req, res) => {
  try {
    const id = parseInt(req.params.id);
