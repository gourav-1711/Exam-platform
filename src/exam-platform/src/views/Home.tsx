...
import {
  ...
  List, Cpu, BookMarked, Bot, Play, GraduationCap, Star,
...
const FEATURES: Feature[] = [
  { label: "Daily Free Quiz",       sublabel: "OPEN NOW", icon: Zap,        iconBg: "bg-teal-100",   iconColor: "text-teal-600",   href: "/quiz",            isNew: true },
  { label: "Daily Current Affairs", sublabel: "OPEN NOW", icon: Newspaper,  iconBg: "bg-blue-100",   iconColor: "text-blue-600",   href: "/current-affairs"              },
  { label: "Study Notes",           sublabel: "OPEN NOW", icon: BookOpen,   iconBg: "bg-orange-100", iconColor: "text-orange-600", href: "/study-notes"                  },
  { label: "Mock Tests",            sublabel: "OPEN NOW", icon: FlaskConical,iconBg: "bg-violet-100",iconColor: "text-violet-600", href: "/mock-tests"                   },
  { label: "PYQ's",                 sublabel: "OPEN NOW", icon: RotateCcw,  iconBg: "bg-pink-100",   iconColor: "text-pink-600",   href: "/pyq",             isNew: true },
  { label: "PYP's",                 sublabel: "OPEN NOW", icon: FileText,   iconBg: "bg-sky-100",    iconColor: "text-sky-600",    href: "/pyp"                          },
  { label: "Syllabus",              sublabel: "OPEN NOW", icon: List,       iconBg: "bg-emerald-100",iconColor: "text-emerald-600",href: "/syllabus"                     },
  { label: "NCERT MCQ's",           sublabel: "OPEN NOW", icon: Cpu,        iconBg: "bg-indigo-100", iconColor: "text-indigo-600", href: "/ncert-mcq",       isNew: true },
  { label: "NCERT Books",           sublabel: "OPEN NOW", icon: BookMarked, iconBg: "bg-amber-100",  iconColor: "text-amber-600",  href: "/ncert-books"                  },
  { label: "AI Learning Support",   sublabel: "OPEN NOW", icon: Bot,        iconBg: "bg-purple-100", iconColor: "text-purple-600", href: "/support"                      },
];
...
// ─── Announcement config (must be above AnnouncementBanner) ───────────────────
const TYPE_CONFIG = {
      ...
      <AnimatePresence initial={false}>
        {visible.map((ann) => {
          ...
          return (
            ...
            >
              <div className={cn("rounded-2xl border p-3.5 flex gap-3 items-start shadow-sm", cfg.bg, cfg.border)}>
                <div className={cn("w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mt-0.5 border", cfg.bg, cfg.border)}>
...
// ─── FeatureCard (must be above Home) ─────────────────────────────────────────
